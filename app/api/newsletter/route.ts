...
Free UK delivery over £40. Arrives in 7–14 days, fully tracked.`,
  html: `<div style="margin:0 auto;max-width:560px;background:#faf7f4;color:#241f1d;padding:48px 32px;font-family:Arial,sans-serif;line-height:1.6">
    ...
    <p style="margin:0;color:#6e625d;font-size:13px">Free UK delivery over £40. Arrives in 7–14 days, fully tracked.</p>
  </div>`,
};
