...
export default function ContactPage() {
  ...
  return (
    <main className="contact-page">
      ...
      <section className="contact-main"><div className="site-container contact-grid"><div className="contact-details"><span className="eyebrow">Contact Veylo</span><h2>A small team,<br />with real replies.</h2><p>We answer messages Monday to Friday and usually come back within two working days.</p><div className="contact-methods"><a href="mailto:hello@veyloskin.co.uk"><Mail size={20} /><span><small>Email</small>hello@veyloskin.co.uk</span></a><div><MapPin size={20} /><span><small>Based in</small>United Kingdom</span></div><a href="https://www.instagram.com"><MessageCircle size={20} /><span><small>Social</small>@veyloskin</span></a></div></div><ContactForm /></div></section>
