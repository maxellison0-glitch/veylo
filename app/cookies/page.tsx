    ...
    <main className="legal-page">
      <div className="site-container legal-container">
        ...
        <section>
          ...
          <ul>
            <li><strong>Meta Pixel and Conversions API (Facebook/Instagram)</strong>: where you consent, tracks page views, add-to-cart and purchase events to measure ad performance and build audiences. Purchase events may also be sent securely from our payment server so they are not lost if the confirmation page is closed. Set by or shared with Meta. See <a href="https://www.facebook.com/privacy/policy/" target="_blank" rel="noopener noreferrer">Meta&apos;s privacy policy</a></li>
